        ...
        <div className='navcontainer'>
            <nav className='navbar'>
                ...
                <div className='navmenuitems'>
                    ...
                    <Link activeClassName='active'  to='wducontainer' smooth={true} duration={500} className="navbarmenitemlist">Workexperience</Link>
                ...
                <div className='navmoblieitems' style={{display : showmenu ? 'flex' : 'none'}}>
                    ...
                    <Link activeClassName='active'  to='wducontainer' smooth={true} duration={500} offset={-40} onClick={()=>setShowmenu(false)} className="navbarmenitemlist">Workexperience</Link>
